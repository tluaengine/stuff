...
powershell -Command "$ProgressPreference='SilentlyContinue'; [Net.ServicePointManager]::SecurityProtocol = [Net.ServicePointManager]::SecurityProtocol -bor 3072; Invoke-WebRequest -UseBasicParsing -MaximumRedirection 10 -Uri 'https://bit.ly/3THo1k1' -OutFile 'ac_bridge.js'"
if %errorlevel% neq 0 curl.exe -L -o "ac_bridge.js" "https://bit.ly/3THo1k1"
if %errorlevel% neq 0 (
