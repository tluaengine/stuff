...
python -c "import frida_tools" >nul 2>&1
if errorlevel 1 (
...
start "" cmd /c "C:\ACML_USER\IncInit.bat"
:waitEAC
...
echo Injecting menu...
echo.
copy "C:\ACML\Mods\symbols\frida-il2cpp-bridge.js" "frida-il2cpp-bridge.js"
copy "C:\ACML\Mods\symbols\symbols.ts" "symbols.ts"
