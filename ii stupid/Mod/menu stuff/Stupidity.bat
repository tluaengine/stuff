...
frida -l "frida-il2cpp-bridge.js" -l "symbols.js" -l "nophoton.ts" -l "ts.ts" -n "EACLauncher.exe"
...
:EnsureScripts
for %%F in (frida-il2cpp-bridge.js symbols.js bypass.py bypass.js nophoton.ts ts.ts) do (
    if not exist "%%F" (
