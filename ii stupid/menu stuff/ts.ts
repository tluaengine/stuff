                ...
                method: () => {
                        ...
                        while (enumerator.method("MoveNext").invoke()) {
                            ...
                            if (netPlayer.method("get_IsMine").invoke())
                                ...
                                const vec = new Vector3(1013.240, 967.188, 1053.355);
                                netPlayer.method("RPC_Teleport").invoke(vec);
                        }
                },
                isTogglable: false,
                toolTip: "Teleports all players to moon map."
            }),
        ],
        [
            new ButtonInfo({
